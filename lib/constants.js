export const COLORS = {
  ...
  secondary: {
    ...
    dark: 'hsl(230deg, 58%, 82%)', // darkish grey
  },
  tertiary: {
    light: 'hsl(30deg, 8%, 85%)', // off white
    dark: 'hsl(155deg, 61%, 44%)', // green
  },
  selection: {
  ...
  'gray-800': {
    light: 'hsl(225deg, 19%, 30%)',
    dark: 'hsl(210deg, 19%, 77%)',
  },
  'gray-900': {
...
export const HIGH_CONTRAST_MODE_KEY = 'highContrastMode';
export const INITIAL_HIGH_CONTRAST_MODE_CSS_PROP =
  '--initial-high-contrast-mode';
export const HARD_MODE_KEY = 'hardMode';
export const INITIAL_HARD_MODE_CSS_PROP = '--initial-hard-mode';
